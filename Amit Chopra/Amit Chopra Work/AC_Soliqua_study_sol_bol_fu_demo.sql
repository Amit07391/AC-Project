...
create or replace table ac_ehr_soliqua_demo_sol_bol_fu as
select distinct a.* from ac_ehr_soliqua_demo_hba1c_bl_pts a
inner join ac_ehr_sol_rx_hba1c_sol_bol_fu c on a.ptid=c.ptid
order by ptid;
select distinct * from ac_ehr_soliqua_demo_sol_bol_fu
order by 1;

-- COMMAND ----------

create or replace table ac_ehr_soliqua_demo_sol_bol_fu_2 as
...
from ac_ehr_soliqua_demo_sol_bol_fu
order by 1;

select distinct * from ac_ehr_soliqua_demo_sol_bol_fu_2
order by 1;

-- COMMAND ----------

select mean(age_index) as mn, median(age_index) as med, std(age_index) as std, min(age_index) as min
        , percentile(age_index,.25) as p25, percentile(age_index,.5) as median, percentile(age_index,.75) as p75, max(age_index) as max  from ac_ehr_soliqua_demo_sol_bol_fu_2;
...
when age_index >=65 and age_index<=74 then '65-74'
when age_index >=75 then '>=75' end as age_flag, count(distinct ptid) as pts
from ac_ehr_soliqua_demo_sol_bol_fu_2
group by 1
order by 1;
...
create or replace table ac_ehr_soli_demo_sol_bol_fu_wt_bmi_bl as
select distinct a.* from ac_ehr_soli_demo_hba1c_wt_bmi_bl a
inner join ac_ehr_sol_rx_hba1c_sol_bol_fu b on a.ptid=b.ptid
order by a.ptid;
select distinct * from ac_ehr_soli_demo_sol_bol_fu_wt_bmi_bl
order by 1;

-- COMMAND ----------

select count(distinct ptid) from ac_ehr_soli_demo_sol_bol_fu_wt_bmi_bl

-- COMMAND ----------

select mean(bl_BMI) as mn, median(bl_BMI) as med, std(bl_BMI) as std, min(bl_BMI) as min
        , percentile(bl_BMI,.25) as p25, percentile(bl_BMI,.5) as median, percentile(bl_BMI,.75) as p75, max(bl_BMI) as max  from ac_ehr_soli_demo_sol_bol_fu_wt_bmi_bl;
...
else 'null' end as BMI_Flag, count(distinct ptid) as pts from ac_ehr_soli_demo_sol_bol_fu_wt_bmi_bl
group by 1
order by 1;
...
select mean(bl_WT) as mn, median(bl_WT) as med, std(bl_WT) as std, min(bl_WT) as min
        , percentile(bl_WT,.25) as p25, percentile(bl_WT,.5) as median, percentile(bl_WT,.75) as p75, max(bl_WT) as max  from ac_ehr_soli_demo_sol_bol_fu_wt_bmi_bl;
...
else 'null' end as WT_Flag, count(distinct ptid) as pts from ac_ehr_soli_demo_sol_bol_fu_wt_bmi_bl
group by 1
order by 1; 
...
select count(distinct ptid) from ac_ehr_soli_demo_comorb_bl

-- COMMAND ----------

create or replace table ac_ehr_soli_demo_comorb_sol_bol_fu_bl as
select distinct a.* from ac_ehr_soli_demo_comorb_bl a
inner join ac_ehr_sol_rx_hba1c_sol_bol_fu b on a.ptid=b.ptid
order by a.ptid;

select distinct * from ac_ehr_soli_demo_comorb_sol_bol_fu_bl
order by ptid;

-- COMMAND ----------

select count(distinct ptid) from ac_ehr_soli_demo_comorb_sol_bol_fu_bl

-- COMMAND ----------

select distinct diag_flag, count(distinct ptid) as pts from ac_ehr_soli_demo_comorb_sol_bol_fu_bl
group by 1
order by 1;
...
create or replace table ac_ehr_soli_demo_CCI_sol_bol_fu_bl as
select distinct a.ptid, b.dx_name,b.Disease, b.weight_old  from ac_ehr_sol_rx_hba1c_sol_bol_fu a
left join  ac_dx_sol_bl_cci_pat b on a.ptid=b.PTID
order by a.ptid;

select distinct * from ac_ehr_soli_demo_CCI_sol_bol_fu_bl   
order by ptid;
...
create or replace table ac_ehr_soli_demo_CCI_sol_bol_fu_bl_2 as
select distinct ptid, dx_name, disease, sum(weight_old) as weight_new from ac_ehr_soli_demo_CCI_sol_bol_fu_bl
group by 1,2,3
order by 1,2,3;

select distinct * from ac_ehr_soli_demo_CCI_sol_bol_fu_bl_2
...
from (select ptid, sum(weight_new) as cci_score from ac_ehr_soli_demo_CCI_sol_bol_fu_bl_2 group by ptid)
...
from (select ptid, sum(weight_new) as cci_score from ac_ehr_soli_demo_CCI_sol_bol_fu_bl_2
 group by ptid)
group by cat3, description
order by cat3, description
;
...
select count(distinct ptid) as pts from ac_ehr_soliqua_demo_sol_bol_fu_2
where value1<7.5;
...
where value1<8;
  ...
  select mean(value1) as mn, median(value1) as med, std(value1) as std, min(value1) as min
        , percentile(value1,.25) as p25, percentile(value1,.5) as median, percentile(value1,.75) as p75, max(value1) as max  from ac_ehr_soliqua_demo_sol_bol_fu_2;
...
inner join ac_ehr_soliqua_demo_sol_bol_fu_2 b on a.ptid=b.ptid;
...
select count(distinct ptid) from ac_ehr_soliqua_demo_no_glp1_prmx_bl
